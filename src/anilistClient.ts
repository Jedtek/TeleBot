...
import type { AniListMediaJSON, AniListMediaJSONResponse, AniListRecommendationJSON, AniListRecommendationJSONResponse } from './anilistClientResponses';
...
class AniListClient {
    ...
    async _formatResponse(response: AniListMediaJSON): Promise<string> {
        return `
    ...
    async _getReccomendation(): Promise<number> {
        ...
        try {
            ...
            const animeReturn: AniListRecommendationJSONResponse = await animeResponse.json();
    ...
    async getRandomAnime(): Promise<string> {
        const recommendationId: number = await this._getReccomendation();
        let query = `
        ...
        try {
            ...
            const animeReturn: AniListMediaJSONResponse = await animeResponse.json();
